...
Security
Insights
laravStart/resources/assets/js/components/Profile.vue

darren Refactor for code readability
Latest commit 22833bd on 24 Oct 2018
 History
 1 contributor
215 lines (191 sloc)  8.77 KB
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <div class="widget-user-header text-white" style="background-image:url('./img/user_cover.jpg')">
